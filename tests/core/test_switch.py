...
def mock_sun_data():
    ...
    return {
        "sunrise": datetime(2024, 6, 15, 6, 30, tzinfo=timezone.utc),
        "sunset": datetime(2024, 6, 15, 20, 45, tzinfo=timezone.utc),
    }
...
class TestSetWindowsTheme:
    ...
    def test_light_sets_apps_value_1(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_light_sets_system_value_1(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
        mock_openkey.return_value = mock_key
        switch_obj.set_windows_theme("light")
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_dark_sets_apps_value_0(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
        mock_openkey.return_value = mock_key
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_dark_sets_system_value_0(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
        mock_openkey.return_value = mock_key
        switch_obj.set_windows_theme("dark")
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_key_always_closed_on_success(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
        mock_openkey.return_value = mock_key
        switch_obj.set_windows_theme("light")
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_key_always_closed_on_invalid_theme(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
        mock_openkey.return_value = mock_key
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_invalid_theme_does_not_call_setvalue(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_broadcasts_two_messages_on_success(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_openkey.return_value = MagicMock()
        switch_obj.set_windows_theme("light")
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_no_broadcast_on_invalid_theme(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_openkey.return_value = MagicMock()
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_theme_value_is_case_insensitive(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_key = MagicMock()
        mock_openkey.return_value = mock_key
        switch_obj.set_windows_theme("LIGHT")
        mock_setvalue.assert_any_call(mock_key, "AppsUseLightTheme", 0, REG_DWORD, 1)
...
class TestSwitchToLightTheme:
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_switches_when_currently_dark(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_openkey.return_value = MagicMock()
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_switches_when_theme_is_none(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_openkey.return_value = MagicMock()
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_skips_registry_when_already_light(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
...
class TestSwitchToDarkTheme:
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_switches_when_currently_light(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        mock_openkey.return_value = MagicMock()
        switch_obj.theme = "light"
    ...
    @patch("src.core.switch.SetValueEx")
    @patch("src.core.switch.OpenKey")
    def test_skips_registry_when_already_dark(self, mock_openkey, mock_setvalue, mock_windll, switch_obj):
        switch_obj.theme = "dark"
        switch_obj.switch_to_dark_theme()
        mock_setvalue.assert_not_called()
...
class TestGetSunHours:
    ...
    def test_ignores_stale_cache_and_recalculates(self, switch_obj, tmp_path, mock_sun_data):
        stale = {"timestamp": "2000-01-01", "sunrise": "05:00:00", "sunset": "15:00:00"}
        (tmp_path / "ephemeris.json").write_text(json.dumps(stale))

        with patch.object(Paths, "get_data_dir", return_value=tmp_path):
            with patch("src.core.switch.sun", return_value=mock_sun_data):
                result = switch_obj.get_sun_hours()
    ...
    def test_saves_cache_file_after_calculation(self, switch_obj, tmp_path, mock_sun_data):
        with patch.object(Paths, "get_data_dir", return_value=tmp_path):
            with patch("src.core.switch.sun", return_value=mock_sun_data):
